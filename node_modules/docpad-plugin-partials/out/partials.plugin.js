  ...
  return PartialsPlugin = (function(_super) {
    ...
    PartialsPlugin.prototype.extendCollections = function(opts) {
      ...
      docpad.setCollection('partials', docpad.database.createLiveChildCollection().setQuery('isLayout', {
        ...
        if ((_base = model.attributes).isPartial == null) {
          _base.isPartial = true;
        }
        if ((_base1 = model.attributes).render == null) {
          _base1.render = false;
        }
        return (_base2 = model.attributes).write != null ? (_base2 = model.attributes).write : _base2.write = false;
      }));
      return this;
    };
    ...
    PartialsPlugin.prototype.extendTemplateData = function(_arg) {
      ...
      templateData.partial = function() {
        var err, file, message, objs, partial, partialFuzzyPath, partialName, _ref1;
        ...
        partial.data = objs.length >= 2 ? (objs.unshift({}), extendr.shallowExtendPlainObjects.apply(extendr, objs)) : (_ref1 = objs[0]) != null ? _ref1 : {};
        ...
        if (partial.task == null) {
          partial.task = new Task(function(complete) {
            return me.renderPartial(partial, function(err, result) {
              var _ref2;
              partial.err = err;
              partial.result = (_ref2 = result != null ? result : err != null ? err.toString() : void 0) != null ? _ref2 : '???';
              return complete();
            });
          });
        }
